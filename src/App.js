    ...
    <div className="wrapper">
      <header>
        ...
        <ul className="headerRight">
          <li>
            <img width={18} height={18} alt='avatar' src='/img/avatar.png' /> <span>1205p</span>
          </li>
          <li>
          <img width={18} height={18} alt='cart' src='/img/shopping-cart.png' />
          </li>
        </ul>
      </header>
